...
% In this thesis the results of the search of the \dst dibaryon at the CERN Large Hadron Collider (LHC),
% with the ALICE experiment are presented.
% The \dst dibaryon is an exotic state 
