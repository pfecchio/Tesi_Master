...
The QCD is a non-Abelian quantum gauge theory, based on the invariance under local
...
The journey of the High Energy Nuclear Physics started in the '70s at the Lawrence Berkeley National
...
From Eq.~\eqref{eq:ABprob}, $\mathrm{N}_{coll}$ can be derived as a function of the impact parameter 
...
\begin{enumerate}
    ...
    \item \textbf{\pmb{\Large$\tau_{0}$}} $\, \pmb{\lesssim}$ \textbf{\textit{t}} $\, \pmb{\lesssim}$ \textbf{\textit{10} fm/\textit{c}:}
