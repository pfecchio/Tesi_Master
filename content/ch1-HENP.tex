...
The aim is to improve our understanding of the behaviour of the matter in extreme conditions and of the
...
In the renormalisation process of the theory, the non-Abelian nature of the QCD brings to the 
...
These quantities are expressed in terms of the impact parameter $\vec{b}$, which characterises
...
\begin{enumerate}
    ...
    \item \textbf{\textit{1}} $\, \pmb{\lesssim}$ \textbf{\textit{t}} $\, \pmb{\lesssim}$ \textbf{\textit{10} fm/\textit{c}:}
            ...
            experimental data.
            As a consequence of the expantion, the system cools down and the energy density decreases, transtiing eventually
    ...
    \item \textbf{\textit{10}} $\, \pmb{\lesssim}$ \textbf{\textit{t}} $\, \pmb{\lesssim}$ \textbf{\textit{15} fm/\textit{c}:}
            ...
            When elastic interactions ends as well, the particles momentum spectra are fixed and this occours
...
One of the main reasons behind this generalisation is that proton spectra are easier to measure
in an experiment.
