...
with low masses are particular interesting because of their expected narrow width.
...
These models derive and effective potential \ -- as the Nijmegen potential
~\cite{dibpred1,dibpred2,dibpred3} -- \ predicting a multitude of dibaryon resonances
...
deeply bound that they would be stable with respect to strong decay 
~\cite{dsinevitable1,dsinevitable2}.
...
They rather emphasised the particular importance of the "inevitable" dibaryon, as they called
it ~\cite{dsinevitable1}.
...
In contrast, the MIT and cloudy bag model calculations 
~\cite{dibpred2,dibpred5,dibpred6} obtained for it binding energies relative to the
