...
In order to increase that rate a second trigger, called \code{FAST}, allows
...
In the first stage the \code{CODEX} analyse the considered data sample on the WLCG (Sec.~\ref{sec:offline})
