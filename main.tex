...
\newcommand{\mom}    {\mbox{\ensuremath{\mathrm{MeV}/c}}\xspace}
\newcommand{\gmom}   {\mbox{\ensuremath{\mathrm{GeV}/c}}\xspace}
\newcommand{\mass}   {\mbox{\ensuremath{\mathrm{GeV}/c^{2}}}\xspace}
\newcommand{\Mmass}  {\mbox{\ensuremath{\mathrm{MeV}/c^{2}}}\xspace}
...
% \input{content/ch2-ALICE}		% INCLUDE: ALICE chapter
\cleardoublepage
